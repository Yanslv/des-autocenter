...
import { OBSERVACAO_PADRAO } from '../utils/orcamento';

export const orcamentoPdfCss = `
.orcamento-pdf { box-sizing: border-box; width: 794px; padding: 0 0 16px; font-family: system-ui, -apple-system, Helvetica, Arial, sans-serif; color: #1a1a1a; font-size: 13px; line-height: 1.45; background: #fff; }
...
.orcamento-pdf .empresa-info .nome { font-size: 17px; font-weight: 700; letter-spacing: 0.2px; color: #1a1a1a; }
.orcamento-pdf .empresa-info .segmento { font-size: 10px; color: #555; text-transform: uppercase; letter-spacing: 0.6px; margin: 2px 0 5px; font-weight: 600; }
.orcamento-pdf .empresa-info .contato { font-size: 11px; color: #444; }
.orcamento-pdf .doc-info { text-align: right; flex-shrink: 0; }
.orcamento-pdf .doc-info .titulo { font-size: 13.5px; font-weight: 700; color: #1a1a1a; letter-spacing: 1px; margin-bottom: 6px; text-transform: uppercase; }
.orcamento-pdf .doc-info .linha { font-size: 11px; color: #444; }
...
.orcamento-pdf .secao-titulo { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; color: #555; margin-bottom: 6px; }
...
.orcamento-pdf .campo .rotulo { font-size: 11px; color: #555; flex-shrink: 0; }
.orcamento-pdf .campo .valor { font-size: 12.5px; color: #1a1a1a; font-weight: 600; text-align: right; }
.orcamento-pdf .veiculo-titulo { font-size: 14.5px; font-weight: 700; margin-bottom: 8px; padding-bottom: 7px; border-bottom: 1px solid #f2f2f2; color: #1a1a1a; }
.orcamento-pdf table { width: 100%; border-collapse: collapse; font-size: 12.5px; }
.orcamento-pdf thead th { text-align: left; color: #444; background: transparent; font-weight: 700; font-size: 10.5px; text-transform: uppercase; letter-spacing: 0.4px; padding: 0 9px 6px; border-bottom: 1px solid #e8e8e8; }
...
.orcamento-pdf .col-item { width: 6%; color: #555; }
.orcamento-pdf .desc-secundaria { display: block; color: #555; font-size: 11px; margin-top: 1px; }
.orcamento-pdf .tabela-total { display: flex; justify-content: space-between; align-items: center; padding: 7px 9px; font-size: 12.5px; font-weight: 700; background: #fafafa; border-top: 1px solid #eee; }
.orcamento-pdf .tabela-total .rotulo-total { color: #555; font-weight: 600; text-transform: uppercase; font-size: 10.5px; letter-spacing: 0.4px; }
.orcamento-pdf .resumo-bloco { background: #fafafa; color: #1a1a1a; padding: 13px 16px; margin: 12px 0; }
.orcamento-pdf .resumo-linha { display: flex; justify-content: space-between; gap: 24px; font-size: 12px; padding: 2px 0; color: #444; }
.orcamento-pdf .resumo-linha span:last-child { font-size: 12.5px; color: #1a1a1a; font-weight: 500; text-align: right; }
...
.orcamento-pdf .resumo-total .rotulo { font-size: 12.5px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.6px; color: #1a1a1a; }
.orcamento-pdf .resumo-total .valor { font-size: 28px; font-weight: 800; color: #1a1a1a; letter-spacing: 0.2px; }
...
.orcamento-pdf .condicao-item .rotulo { font-size: 10.5px; color: #555; text-transform: uppercase; letter-spacing: 0.3px; margin-bottom: 2px; }
.orcamento-pdf .condicao-item .valor { font-size: 13px; font-weight: 700; color: #1a1a1a; }
.orcamento-pdf .observacoes { font-size: 11.5px; color: #444; padding: 8px 12px; background: #fafafa; }
.orcamento-pdf .aprovacao-bloco { border: 1px solid #eee; padding: 11px 14px; }
.orcamento-pdf .aprovacao-texto { font-size: 12px; color: #444; margin-bottom: 12px; }
.orcamento-pdf .assinatura-grid { display: grid; grid-template-columns: 2fr 1fr; gap: 22px; margin-top: 22px; }
.orcamento-pdf .linha-assinatura { border-top: 1px solid #ddd; padding-top: 4px; font-size: 10.5px; color: #555; text-align: center; text-transform: uppercase; letter-spacing: 0.4px; }
.orcamento-pdf .campo-nome-cliente { font-size: 11.5px; color: #444; }
...
.orcamento-pdf .rodape { margin-top: 12px; padding-top: 8px; border-top: 1px solid #f0f0f0; text-align: center; font-size: 10.5px; color: #555; }
`;
  ...
  <div className="orcamento-pdf">
    ...
    <div className="cabecalho">
      ...
      <div className="doc-info">
        <div className="titulo">{modelo.tituloDocumento}</div>
        <div className="linha">
    ...
    <div className="resumo-bloco">
      ...
      <div className="resumo-total">
        <span className="rotulo">{modelo.rotuloTotal}</span>
    ...
    <div className="secao">
      ...
      <div className="condicoes-grid">
        ...
        <div className="condicao-item">
          <div className="rotulo">{modelo.rotuloCondicao3}</div>
    ...
    <div className="secao">
      <div className="secao-titulo">{modelo.rotuloAprovacao}</div>
      <div className="aprovacao-bloco">
        <div className="aprovacao-texto">{modelo.textoAprovacao}</div>
