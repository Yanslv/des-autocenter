...
export const PecasServicosForm: React.FC<{
  ...
  const [tipoAdd, setTipoAdd] = useState<'servico' | 'peca'>('peca');
      ...
      {podeEditar && (
        <>
          <div className="grid grid-cols-2 gap-1">
            <button
              type="button"
              onClick={() => setTipoAdd('peca')}
              className={`py-1.5 rounded-md text-[11px] font-semibold ${
                tipoAdd === 'peca' ? 'bg-[#cd3f00] text-white' : 'bg-neutral-100'
              }`}
            >
              Peça
            </button>
            <button
              type="button"
              onClick={() => setTipoAdd('servico')}
              className={`py-1.5 rounded-md text-[11px] font-semibold ${
                tipoAdd === 'servico' ? 'bg-[#cd3f00] text-white' : 'bg-neutral-100'
              }`}
            >
              Serviço
            </button>
